  ...
  return (
    ...
    >
      ...
      <div className="relative h-48 overflow-hidden bg-gray-200 dark:bg-gray-700">
        ...
        {/* Sponsored Badge */}
        {sponsored && (
          <span className="absolute top-2 left-2 bg-yellow-500 text-white px-3 py-1 rounded-full text-xs font-semibold shadow-lg">
            ⭐ Sponsored
          </span>
        )}
        ...
        <div className="absolute top-2 right-2 flex gap-2">
          <motion.button
            ...
            className={`p-2 rounded-full shadow-lg transition-colors ${
              saved ? 'bg-red-500 text-white' : 'bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'
            }`}
          ...
          <motion.button
            ...
            className={`p-2 rounded-full shadow-lg transition-colors ${
              inCompare ? 'bg-primary-600 text-white' : 'bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'
            }`}

...
const LiveChat = ({ dealerId: _dealerId, dealerName = 'Dealer' }) => {
      ...
      <AnimatePresence>
        {!isOpen && (
          <motion.button
            ...
            className="bg-primary-600 hover:bg-primary-700 text-white rounded-full p-4 shadow-lg flex items-center gap-2 group"
          >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-white/80">
                    {t('chat.online', 'Online')} • {t('chat.typicallyReplies', 'Typically replies instantly')}
                  </div>
                </div>
              </div>
              <button
